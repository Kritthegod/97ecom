...
$sql = "select l.laptop_id, b.brand_name as brand, l.model, l.ram, l.cpu, l.hdd, l.display, l.color, l.year, l.filepath from laptop l, brand b where l.brand = b.brand_id";
try {
    $stmt = $conn->query($sql);
    $laptops = $stmt->fetchAll(PDO::FETCH_ASSOC); //PDO::FETCH_NUM
    // print_r($brand);
                        ...
                        if (isset($laptops)) {
                            foreach ($laptops as $laptop) {
                                echo "<tr>
                                        ...
                                        <td>$laptop[color]</td>
                                        <td>$laptop[year]</td>
                                        <td><img src=$laptop[filepath] style='height: 100px;width: 75px;'></td>
